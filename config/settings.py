...
ALLOWED_HOSTS = ["*"]  # на проде будет строго
...
# -----------------------
# Password Reset (Stage 1)
# -----------------------
PASSWORD_RESET_TOKEN_EXPIRY_TIME = 24  # hours

# -----------------------
# Email (Stage 1: console)
# -----------------------
...
# важно для стабильности (особенно если потом будут ретраи)
CELERY_TASK_ACKS_LATE = True
CELERY_WORKER_PREFETCH_MULTIPLIER = 1

SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=1),
    "REFRESH_TOKEN_LIFETIME": timedelta(days=2),  # 48 hour for refresh user token
